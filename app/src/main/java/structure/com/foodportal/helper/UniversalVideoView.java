...
public class UniversalVideoView extends SurfaceView
    ...
    public UniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, com.universalvideoview.R.styleable.UniversalVideoView, 0, 0);
        mFitXY = a.getBoolean(com.universalvideoview.R.styleable.UniversalVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(com.universalvideoview.R.styleable.UniversalVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(com.universalvideoview.UniversalVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(com.universalvideoview.UniversalVideoView.class.getName());
        }
    }
