  ...
  //  private View mBackButton;// 返回按钮
   ...
   /// private View mTitleLayout;
    ...
    public UniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, com.universalvideoview.R.styleable.UniversalMediaController);
        mScalable = a.getBoolean(com.universalvideoview.R.styleable.UniversalMediaController_uvv_scalable, false);
        a.recycle();
        init(context);
    }
...
//        }
    ...
    public void setMediaPlayer(UniversalMediaController.MediaPlayerControl player) {
        mPlayer = player;
        updatePausePlay();
    }
...
//        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_COMPLETE: //7
                    showCenterView(com.universalvideoview.R.id.center_play_btn);
                    break;
                case SHOW_ERROR: //5
                 //   show();
                    showCenterView(com.universalvideoview.R.id.error_layout);
                    break;
                case HIDE_LOADING: //4
                case HIDE_ERROR: //6
    ...
    private void showCenterView(int resId) {
        if (resId == com.universalvideoview.R.id.loading_layout) {
        ...
        } else if (resId == com.universalvideoview.R.id.center_play_btn) {
            if (mCenterPlayButton.getVisibility() != VISIBLE) {
        ...
        } else if (resId == com.universalvideoview.R.id.error_layout) {
            if (errorLayout.getVisibility() != VISIBLE) {
