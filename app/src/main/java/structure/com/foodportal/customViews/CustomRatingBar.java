...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarHalfResource = R.drawable.star_off;
    ...
    private void initializeAttributes(AttributeSet attrs, Context context) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            else if (attr == R.styleable.CustomRatingBar_starMargin)
                mStarMargin = a.getDimension(attr, 0);
    ...
    public void setSelectedUnselectedStar(int selected, int unselected) {
        mStarOnResource = mStarHalfResource = selected;
        mStarOffResource = unselected;
        refreshStars();
    }
    ...
    private ImageView createStar() {
        ...
        params.weight = 1;
        params.setMargins((int)mStarMargin,0,0,0);
