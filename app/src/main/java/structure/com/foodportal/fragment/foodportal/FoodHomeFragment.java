...
import structure.com.foodportal.adapter.foodPortalAdapters.FoodLatestVideosAdapter;
...
import structure.com.foodportal.helper.CirclePagerIndicatorDecoration;
...
public class FoodHomeFragment extends BaseFragment implements View.OnClickListener, FoodBannerListner, FoodHomeListner {
    ...
    FoodPopularRecipeAdapter foodRamdanRecipeAdapter;
    ...
    ArrayList<Sections> sectionsRamdanReceipe;
...
//    }
    ...
    CardView featurecv, latestReceipecv, popularcv, cvRecommendedSection, cvLatestSection, cvRecommendedImageCard, cvSectionLatestVideos, cvRamdanSection;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  latestReceipecv = binding.getRoot().findViewById(R.id.latestCardView);
        ...
        cvSectionLatestVideos = binding.getRoot().findViewById(R.id.cvSectionLatestVideos);
        cvRecommendedImageCard = binding.getRoot().findViewById(R.id.cvRecommendedImageCard);
        cvRamdanSection = binding.getRoot().findViewById(R.id.cvRecommendedImageCard);
    ...
    private void setListners() {
        ...
        sectionsRamdanReceipe = new ArrayList<>();
        ...
        //ramdan section adapter
        foodRamdanRecipeAdapter = new FoodPopularRecipeAdapter(sectionsRamdanReceipe, mainActivity, this, "ramdan_receipe");
        ...
        foodRamdanRecipeAdapter.setPreferenceHelper(preferenceHelper);
       ...
       /* RecyclerView.ItemAnimator itemAnimator = new DefaultItemAnimator();
        ...
        binding.rvRamdanRecipe.setLayoutManager(new GridLayoutManager(mainActivity, 1, GridLayoutManager.HORIZONTAL, false));
        ...
        binding.rvRamdanRecipe.setAdapter(foodRamdanRecipeAdapter);
        ...
        LinearSnapHelper snapHelperLatestVideos = new LinearSnapHelper();
        snapHelperLatestVideos.attachToRecyclerView(binding.rvLatestVideos);

        CirclePagerIndicatorDecoration pagerIndicatorDecoration = new CirclePagerIndicatorDecoration();
        binding.rvLatestVideos.addItemDecoration(pagerIndicatorDecoration);
    ...
    public void setData(FoodHomeModelWrapper foodHomeModelWrapper) {
        ...
        switch (navSection) {
          ...
          //      latestReceipecv.setVisibility(View.VISIBLE);
                cvSectionLatestVideos.setVisibility(View.GONE);
                featurecv.setVisibility(View.VISIBLE);
                cvRecommendedSection.setVisibility(View.VISIBLE);
                cvLatestSection.setVisibility(View.GONE);
                cvRamdanSection.setVisibility(View.VISIBLE);
...
//                        binding.tvTipTitle.setText(foodHomeModelWrapper.getSection().get(2).getSection_list().get(0).getTitle_en() + "...");
                        binding.tvTipTitle.setText(getString(R.string.tip_title_en) + "...");
...
//                        binding.tvBetterforBites.setText(foodHomeModelWrapper.getSection().get(3).getSection_name_en().replaceAll("_", " "));
                        binding.tvBetterforBites.setText(getString(R.string.chef_special_en));
...
//                        binding.tvRecommended.setText(foodHomeModelWrapper.getSection().get(5).getSection_name_en().replaceAll("_", " "));
                        binding.tvRecommended.setText(getString(R.string.recommended_recipes_en));
...
//                        binding.tvTipTitle.setText(foodHomeModelWrapper.getSection().get(2).getSection_list().get(0).getTitle_ur() + "...");
                        binding.tvTipTitle.setText(getString(R.string.tip_title_ur) + "...");
...
//                        binding.tvBetterforBites.setText(foodHomeModelWrapper.getSection().get(3).getSection_name_ur().replaceAll("_", " "));
                        binding.tvBetterforBites.setText(getString(R.string.chef_special_ur));
...
//                        binding.tvRecommended.setText(foodHomeModelWrapper.getSection().get(5).getSection_name_ur().replaceAll("_", " "));
                        binding.tvRecommended.setText(getString(R.string.recommended_recipes_ur));
...
//                printList("ListFeaturedBefore", foodHomeModelWrapper.getSection().get(1).getSection_list());
                ...
                sectionsLatestVideos.addAll(foodHomeModelWrapper.getSection().get(8).getSection_list());
                sectionsLatestReceipe.addAll(foodHomeModelWrapper.getSection().get(6).getSection_list());
                sectionsRamdanReceipe.addAll(foodHomeModelWrapper.getSection().get(7).getSection_list());
...
//                printList("ListFeaturedAfter", sectionsFeatured);
            ...
            case AppConstant.FOODPORTAL_FOOD_DETAILS.TUTORIALS:
                ...
                switch (preferenceHelper.getSelectedLanguage()) {
                    ...
                    default:
//                        binding.tvPopularRecipe.setText(foodHomeModelWrapper.getSection().get(0).getSection_name_en().replaceAll("_", " "));
                        binding.tvPopularRecipe.setText(getString(R.string.latest_en));

                        binding.tvFeaturedRecipes.setText(foodHomeModelWrapper.getSection().get(1).getSection_name_en().replaceAll("_", " "));

//                        binding.tvBetterforBites.setText(foodHomeModelWrapper.getSection().get(2).getSection_name_en().replaceAll("_", " "));
                        binding.tvBetterforBites.setText(getString(R.string.knife_tutorial_en));

                        break;
                    case URDU:
//                        binding.tvPopularRecipe.setText(foodHomeModelWrapper.getSection().get(0).getSection_name_ur().replaceAll("_", " "));
                        binding.tvPopularRecipe.setText(getString(R.string.latest_ur));

                        binding.tvFeaturedRecipes.setText(foodHomeModelWrapper.getSection().get(1).getSection_name_ur().replaceAll("_", " "));

//                        binding.tvBetterforBites.setText(foodHomeModelWrapper.getSection().get(2).getSection_name_ur().replaceAll("_", " "));
                        binding.tvBetterforBites.setText(getString(R.string.knife_tutorial_ur));
                        break;
                }
                ...
                foodRamdanRecipeAdapter.setWidth(291);
            ...
            case AppConstant.FOODPORTAL_FOOD_DETAILS.CLEANING:
                ...
                binding.cvSectionFive.setVisibility(View.GONE);
                cvRamdanSection.setVisibility(View.GONE);
...
//                foodPopularRecipeAdapter.setWidth(291);
                ...
                binding.cvSectionLatestVideos.setVisibility(View.GONE);
                binding.lltipoftheday.setVisibility(View.GONE);
                binding.cvSectionZero.setVisibility(View.GONE);
                ...
                binding.cvSectionFive.setVisibility(View.GONE);
                binding.rvCategoryslider.setVisibility(View.GONE);
                binding.cvRamdanSection.setVisibility(View.GONE);
                binding.cvRecommendedSection.setVisibility(View.GONE);
                binding.cvLatestSection.setVisibility(View.VISIBLE);
                binding.cvRecommendedImageCard.setVisibility(View.GONE);

                switch (preferenceHelper.getSelectedLanguage()) {
                    case ENGLISH:
                    default:
//                        binding.tvLatest.setText(foodHomeModelWrapper.getSection().get(0).getSection_name_en().replaceAll("_", " "));
                        binding.tvLatest.setText(getString(R.string.latest_en));
                        break;
                    case URDU:
//                        binding.tvLatest.setText(foodHomeModelWrapper.getSection().get(0).getSection_name_ur().replaceAll("_", " "));
                        binding.tvLatest.setText(getString(R.string.latest_ur));
                        break;
                }
...
//                sectionsLatest.addAllToAdapter(foodHomeModelWrapper.getSection().get(0).getSection_list());
        ...
        foodRamdanRecipeAdapter.notifyDataSetChanged();
    ...
    public void popularrecipe(int pos , String screen)
    {
        ...
        else if(screen == "ramdan_receipe"){
            next(sectionsRamdanReceipe.get(pos).getSlug());
        }
        else
