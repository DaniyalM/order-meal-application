...
public class FoodSpecialIngredientAdapter extends RecyclerView.Adapter<FoodSpecialIngredientAdapter.PlanetViewHolder> {
    ...
    public void onBindViewHolder(FoodSpecialIngredientAdapter.PlanetViewHolder holder, int position) {
        ...
        mLang = mPreferenceHelper.getSelectedLanguage();

        holder.masalaname.setText(mLang == ENGLISH ? ingredientList.get(position).getTitle_en() : ingredientList.get(position).getTitle_ur());
        ...
        public PlanetViewHolder(View itemView) {
            ...
            radioButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    specialStepListener.specialClick(mLang == ENGLISH ? ingredientList.get(lastCheckedPosition).getIngredient_en() : ingredientList.get(lastCheckedPosition).getIngredient_ur());
